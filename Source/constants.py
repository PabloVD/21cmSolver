...
hnu_0 = 13.6    # eV
sigmaH = 7.91e-18   # Ion cross section at 13.6 eV, cm^2
...
zdec = 150.*(Omega_b*hlittle**2./0.023)**(2./5.) - 1.   # z decoupling of Tk
...
nualpha = 2.47e15   # Hz
Aalpha = 6.25e8 # s^-1
tauGP = 3.*c**3.*Aalpha*n0_h/(8.*np.pi*nualpha**3.*H0*np.sqrt(Omega_m))*10.**(3./2.)    # tau_GP at z=10, da mal!

# Ionization cross section fit parameters
alist = [6.30e-18,7.83e-18,1.58e-18] # cm^2
blist = [1.34,1.66,1.34]
nuTlist = [3.282e15/nu_over_ev,5.933e15/nu_over_ev,13.13e15/nu_over_ev] # eV
slist = [2.99,2.05,2.99]
